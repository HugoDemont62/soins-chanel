...
const MaRoutineSection = () => {
  ...
  const handleCreateRoutine = () => {
    navigate('/routine');  // Navigation vers la nouvelle page
  };
      ...
      <div className="routine-container">
        ...
        <div ref={contentRef} className="routine-content-section">
          ...
          <p ref={descriptionRef} className="routine-description">
            Parce que chaque peau est unique, CHANEL vous propose une routine
            personnalisée, conçue à partir de vos besoins, de vos priorités, de
            votre rythme. Des formules d'exception, des textures choisies avec
            soin, pour une expérience de beauté aussi précise qu'intime.
          </p>
